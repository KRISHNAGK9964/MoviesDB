  ...
  render() {
    ...
    if ( this.state.currText === "") {
      ...
      filteredMovies = filteredMovies.filter((movieObj) => {
        ...
        return movieName.includes(this.state.currText); // [t , o, p ,  , g , u , n ,  , m,a,v,a,r,i,c,k]
      });
    }
      ...
      <div class="row" style={{width: '100%'}}>
          ...
          <ul class="list-group">
            {
              this.state.genre.map((genre)=> (
                this.state.currGenre == genre ? 
                  <li class="list-group-item active" style={{cursor: "pointer"}} aria-current="true" >
                    {genre}
                  </li> : 
                  <li class="list-group-item" style={{cursor: "pointer"}} onClick={()=> this.setGenre(genre)}>{genre}</li>
              ))
            }
          </ul>
        </div>
        <div class="col favourites-table">
          <div class="row">
            ...
            <input type="number" className="col-4" placeholder="5" value={this.state.limit} onChange={(e)=> !e.target.value || this.setState({ limit: e.target.value })} ></input>
          </div>
          <div class="row">
            <table class="table">
              <thead>
